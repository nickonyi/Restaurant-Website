...
function createMenu() {
    ...
    menu.appendChild(createMenuItem('Pancakes', '$12.00', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptatum.Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptatum. ', menuImage1));
    menu.appendChild(createMenuItem('Eggs', '$15.00', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptatum.Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptatum.', menuImage2));
    menu.appendChild(createMenuItem('Onions', '$10.00', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptatum.Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptatum.', menuImage3));
    return menu;
}
...
function createMenuItem(name, price, description, image) {
    ...
    menuItemHeader.classList.add('menu__item-header');
    ...
    menuItemHeader.appendChild(menuItemDecoration);
